...
namespace UD_Tinkering_Bytes
{
    ...
    public class GetVendorActionsEvent : IVendorActionEvent<GetVendorActionsEvent>
    {
        ...
        public bool AddAction(string Name, string Display = null, string Command = null, string PreferToHighlight = null, char Key = ' ', int Default = 0, int Priority = 0, int? DramsCost = null, bool FireOnVendor = true, bool FireOnItem = false, bool FireOnPlayer = false, bool Override = false, GameObject FireOn = null, bool WantsAsync = false, bool ClearAndSetUpTradeUI = false)
        {
            Actions ??= new();
